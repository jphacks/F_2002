...
/* ARM CM4 */
    ...
    #define I2C_Pressure_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t I2C_Pressure_SCB_IRQ_cfg;

    #define ADC_Photoresistor_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t ADC_Photoresistor_IRQ_cfg;
