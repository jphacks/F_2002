// ======================================================================
// JPHacks.v generated from TopDesign.cysch
// 11/07/2020 at 13:00
...
module SCB_I2C_PDL_v2_0_4 (
	...
	cy_clock_v1_0
		#(.id("dc6c700e-55cb-4659-bae4-17b81cd82de0/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("78125000"),
		  .is_direct(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dc6c700e-55cb-4659-bae4-17b81cd82de0/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("dc6c700e-55cb-4659-bae4-17b81cd82de0/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module Scan_ADC_v3_10_5 (
	...
	cy_clock_v1_0
		#(.id("d72bb371-9df3-4523-bf60-e61c60ae6a9a/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module top ;
    ...
    SCB_I2C_PDL_v2_0_4 I2C_Pressure (
        .clock(1'b0),
        .scl_b(Net_43),
        .scl_trig(Net_44),
        .sda_b(Net_45));

	wire [0:0] tmpFB_0__Data_Tempreature_Humidity_net;
	electrical [0:0] tmpSIOVREF__Data_Tempreature_Humidity_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Data_Tempreature_Humidity
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Data_Tempreature_Humidity_net[0:0]}),
		  .io({Net_90}),
		  .siovref(tmpSIOVREF__Data_Tempreature_Humidity_net));


	wire [0:0] tmpFB_0__DATA_Photoresistor_net;
	wire [0:0] tmpIO_0__DATA_Photoresistor_net;
	electrical [0:0] tmpSIOVREF__DATA_Photoresistor_net;
	...
	cy_mxs40_gpio_v1_0
		...
		DATA_Photoresistor
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__DATA_Photoresistor_net[0:0]}),
		  .analog({Net_118}),
		  .io({tmpIO_0__DATA_Photoresistor_net[0:0]}),
		  .siovref(tmpSIOVREF__DATA_Photoresistor_net));


    Scan_ADC_v3_10_5 ADC_Photoresistor (
        .eos(Net_106),
        .sdone(Net_107),
        .t_chid(Net_108[3:0]),
        .t_chidv(Net_109),
        ...
        .t_dav(Net_111),
        .t_fvalid(Net_112),
        .t_fvinternal(Net_113[1:0]),
        .t_fvout(Net_114),
        .vagnd(Net_115),
        .vinPlus_0(Net_118),
        .vinPlus_1(Net_126));

	wire [0:0] tmpFB_0__DATA_SoilMoisture_net;
	wire [0:0] tmpIO_0__DATA_SoilMoisture_net;
	electrical [0:0] tmpSIOVREF__DATA_SoilMoisture_net;

	cy_mxs40_gpio_v1_0
		#(.id("f62507c8-e80c-43ca-a4d8-655f534e5a63"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		DATA_SoilMoisture
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__DATA_SoilMoisture_net[0:0]}),
		  .analog({Net_126}),
		  .io({tmpIO_0__DATA_SoilMoisture_net[0:0]}),
		  .siovref(tmpSIOVREF__DATA_SoilMoisture_net));
