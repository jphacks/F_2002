...
*/
cy_stc_scb_uart_config_t const UART_DEBUG_config =
{
...
* structure.
*/
cy_stc_scb_uart_context_t UART_DEBUG_context;
...
*
* \globalvars
* \ref UART_DEBUG_initVar - used to check initial configuration,
...
void UART_DEBUG_Start(void)
{
    ...
    #if defined(UART_DEBUG_SCB_IRQ__INTC_ASSIGNED)
        (void) Cy_SysInt_Init(&UART_DEBUG_SCB_IRQ_cfg, &UART_DEBUG_Interrupt);
    #endif /* (UART_DEBUG_SCB_IRQ__INTC_ASSIGNED) */
...
#if defined(UART_DEBUG_SCB_IRQ__INTC_ASSIGNED)
    NVIC_EnableIRQ((IRQn_Type) UART_DEBUG_SCB_IRQ_cfg.intrSrc);
#endif /* (UART_DEBUG_SCB_IRQ__INTC_ASSIGNED) */
